...
<div class="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:!shadow-none p-3">
                ...
                <div class="ml-5 mt-3 mb-3">
                  <a type="button" href="edit_dataProyek.html?proyekId=#IDEDIT#" class="hover:bg-indigo-400 rounded-md bg-indigo-300 py-3 px-8 text-center text-base font-semibold text-black outline-none">Edit</a>
                </div>`;
